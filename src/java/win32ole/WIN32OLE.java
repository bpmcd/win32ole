...
public class WIN32OLE extends RubyObject {
    ...
    @JRubyMethod(name = "method_missing", meta = true)
...
//                // Property put.
//                if (args.length > 1)
//                    throw getRuntime().newArgumentError("Too many arguments (" + args.length + " for 1)");
...
//                return jacobToRuby(Dispatch.callN(dispatch, name, rubyToJacob(args)));
//            }
//        } catch (ComException e) {
//            // TODO try to raise a better exception type.
//        	e.printStackTrace();
//            RubyArray array = RubyArray.newArrayNoCopy(getRuntime(), args);
//            throw getRuntime().newNoMethodError("No method `" + name + "'", name, array);
//        }
        return self;
    }
    ...
    private Object[] rubyToJacob(IRubyObject[] args) {
